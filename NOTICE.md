...
| RN visual marks | `assets/brand/` | Copyright RN Design & Serviços; see `TRADEMARKS.md` |

The top-level `LICENSE` is GPL-3.0-only and applies to the original project code unless a file or this notice says otherwise.

This project interoperates with [mailcow: dockerized](https://github.com/mailcow/mailcow-dockerized) and [SOGo](https://github.com/Alinto/sogo). It is independent, unofficial and is not endorsed by either upstream project.
